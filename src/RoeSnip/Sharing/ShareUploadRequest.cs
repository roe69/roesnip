...
/// array, not a stream/file handle) since every intended caller already has the bytes in memory (a
/// rendered PNG, or a finished recording's already-saved-to-temp file read whole).</summary>
