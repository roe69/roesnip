...
namespace RoeSnip.Platform.Windows.Interop;

/// <summary>Ported verbatim from src/RoeSnip/Interop/NativeMethods.cs (PLAN.md §5's P/Invoke
/// appendix) — only the namespace changed (PLAN-XPLAT.md §3.2).</summary>
