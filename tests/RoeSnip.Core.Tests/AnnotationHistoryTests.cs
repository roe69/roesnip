...
/// <summary>The pure, UI-framework-free action-based undo/redo model behind AnnotationLayer's shape
/// list (shared by the WPF and Avalonia overlays via RoeSnip.Core). Tested against a plain string
/// payload (not AnnotationShape) to prove the class is genuinely generic/framework-independent.
/// Ported verbatim from the WPF app's tests/RoeSnip.Tests/AnnotationHistoryTests.cs.</summary>
