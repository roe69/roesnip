...
/// displayed output (and #FFE4B5 is CSS "moccasin", which pins the %Na name lookup too). Ported
/// from the WPF app's own tests/RoeSnip.Tests/ColorFormatTemplateTests.cs (item 22).</summary>
