...
public class AutomationProtocolTests
{
    ...
    public void KnownCommands_MatchesTheDocumentedCommandList()
    {
        ...
        // "lastcapture" and "tray" came with the kept still capture. "lastcapture" is live
        // here; "tray" is wire-shape only, since this port's tray menu is a native menu the
        // OS owns and cannot be opened programmatically.
        Assert.Equal(
            new[]
            {
