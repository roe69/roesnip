...
/// palette supports; the slot count is fixed). Ported verbatim from the WPF app's
/// tests/RoeSnip.Tests/SwatchPaletteTests.cs against this port's own SwatchPalette copy.</summary>
public class SwatchPaletteTests
{
    ...
    public void EffectivePalette_LegacyDuplicateOfDefault_IsNotAddedTwice()
    {
        ...
        Assert.Single(result, hex => string.Equals(hex, "#E53935", StringComparison.OrdinalIgnoreCase));
    }
