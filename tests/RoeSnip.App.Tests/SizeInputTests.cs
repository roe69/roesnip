...
/// <summary>The pure parse/clamp/format logic behind the toolbar's numeric size ComboBox. Ported
/// verbatim from the WPF app's tests/RoeSnip.Tests/SizeInputTests.cs against this port's own
/// SizeInput copy.</summary>
