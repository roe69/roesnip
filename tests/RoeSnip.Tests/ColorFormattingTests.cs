...
/// <summary>Golden values for the ColorPickerWindow's format rows (see the round-2 UX brief's
/// worked example: #0d1117 -> rgb(13, 17, 23) -> hsl(216, 28%, 7%) -> "116.4 nits").</summary>
