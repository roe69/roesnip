...
public class UpdateManagerTests
{
    ...
    [Fact]
    public void ParsePayload_GzChosen_StillCarriesThePlainAssetsOwnDigest()
    {
        // ApplyUpdateCoreAsync verifies the .gz's digest before decompressing AND the plain asset's
