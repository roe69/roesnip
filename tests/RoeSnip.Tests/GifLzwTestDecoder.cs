...
/// <summary>Standalone reference GIF-LZW decoder for tests only — <see cref="RoeSnip.Recording.Gif.GifLzwEncoder"/>
...
/// and no insert happens yet). <see cref="RoeSnip.Recording.Gif.GifLzwEncoder"/> must therefore grow
